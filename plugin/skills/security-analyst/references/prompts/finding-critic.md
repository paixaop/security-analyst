...
2. **Exploit Catalog**: `{ALL_FINDINGS}` contains LOD-1 briefs for all findings from the surface through exploits stages with PoCs
...
Finding IDs: Use prefix `CRIT-XXX`
