...
2. Pick the first one that contains `wave-5-final-report.md`
...
- `REPORT_PATH` → `{RUN_DIR}/wave-5-final-report.md` (or legacy path)
...
- `{RUN_DIR}/fix-plan.md` — The implementation plan
