...
The report writer agent produces the final security analysis report following this structure. Output to `{RUN_DIR}/wave-5-final-report.md`.
...
---
    ...
    **Exploit Chains Identified:** [count]
    ...
    [Use the finding format from templates/finding.md]
    ...
    [Use the chain format from templates/finding.md]
    ...
    **ATT&CK Techniques Covered:**
    ...
    | Technique ID | Technique Name | Finding Count |
    |-------------|---------------|---------------|
